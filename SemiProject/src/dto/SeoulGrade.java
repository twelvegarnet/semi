...
//	}
	...
	public String toString() {
		return "SeoulGrade [cgg_code=" + cgg_code + ", y_dents=" + y_dents + ", cob_code_nm=" + cob_code_nm
				+ ", x_cnts=" + x_cnts + ", cgg_code_nm=" + cgg_code_nm + ", tel_no=" + tel_no + ", bizcnd_code_nm="
				+ bizcnd_code_nm + ", upso_sno=" + upso_sno + ", food_menu=" + food_menu + ", upso_nm=" + upso_nm
				+ ", rdn_code_nm=" + rdn_code_nm + ", avg=" + avg + "]";
	}
