...
@WebServlet("/mypage/recipedetail")
public class MyPageRecipeDetailController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/WEB-INF/views/mypage/mypage_recipedetail.jsp")
			.forward(req, resp);
