...
<div class="text-center">
	<ul class="pagination pagination-sm">
		...
		<li><a href="/notice/list">&larr;</a></li>
		<%	} %>
		...
		<li><a href="/notice/list?curPage=<%=paging.getStartPage() - paging.getPageCount() %>">&laquo;</a></li>
		<%	} else { %>
		...
		<li><a href="/notice/list?curPage=<%=paging.getStartPage() + paging.getPageCount() %>">&raquo;</a></li>
		<%	} else { %>
		...
		<!-- 마지막 페이지로 가기 -->
		<%	if(paging.getCurPage() != paging.getTotalPage()) { %>
		<li><a href="/notice/list?curPage=<%=paging.getTotalPage() %>">&rarr;</a></li>
		<%	} %>
